...
- Defines the test-only fixtures/helpers used by later tasks: `shop_item`, `equipped_item`, `referenced_item`, `exchange`, `debt`, `budget`, `transaction`, `goal`, `inactive_account`, `active_account`, `create_daily_habit`, `create_nested_note_tree`, `snapshot_tree`, `snapshot_shop_user_state`, `latest_history_action`, `get_item`, `exchange_history_name`, `create_weekly_target_habit`, `add_completion_dates`, `complete_on`, `count_goal_reward`, `run_startup_migrations`, `has_column`, and `fail_on_second_rename`.
